...
{
    /**
     * Set up the employees table in PostgreSQL.
     */
    public function up()
    {
        ...
        $this->db->query("CREATE INDEX idx_employees_nik ON employees(nik)");
        $this->db->query("CREATE INDEX idx_employees_name ON employees(employee_name)");
    }
    ...
    {
        $this->db->query("DROP TABLE IF EXISTS employees CASCADE");
    }
}
