...
use Modules\MultiSkill\Repositories\EmployeeRepository;

class MultiSkillService
{
    ...
    /**
     * Parse and upsert a list of employees for bulk import
     */
    public function bulkImportEmployees(array $rows)
    {
        ...
        foreach ($rows as $index => $row) {
            ...
            if (is_numeric($data['join_date'])) {
                // Handle Excel timestamp numbers if any
