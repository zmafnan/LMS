...
export default function NonProductionAuditPreview() {
  ...
  const downloadPdf = () => {
    ...
    doc.setFontSize(16)
    doc.text("LAPORAN AUDIT 6S - NON-PRODUCTION", 14, 15)
    ...
    doc.save(`Audit_Report_Non_Production_${audit.Department?.name || "Dept"}_${new Date(audit.audit_date).toISOString().slice(0, 10)}.pdf`)
  }
  return (
